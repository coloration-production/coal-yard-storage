<template>
  <div class="relative inline-flex ml-3">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full right-0 -mr-48 sm:mr-0 min-w-80 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1" >

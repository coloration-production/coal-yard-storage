<template>
  ...
  >
    <div class="sticky top-16 bg-white overflow-x-hidden overflow-y-auto no-scrollbar flex-shrink-0 border-r border-gray-200 md:w-72" style="height: calc(100vh - 64px)">
        ...
        <div class="sticky top-0 z-10">
          <div class="flex items-center bg-white border-b border-gray-200 px-5 h-16">
            <div class="w-full flex items-center justify-between">
              ...
              <ChannelMenu />
              <!-- Edit button -->
              <button class="p-1.5 flex-shrink-0 rounded border border-gray-200 hover:border-gray-300 shadow-sm ml-2">
